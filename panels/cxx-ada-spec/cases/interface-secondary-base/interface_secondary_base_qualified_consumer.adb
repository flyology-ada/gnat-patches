...
procedure Interface_Secondary_Base_Qualified_Consumer is
...
begin
   if Bindings.Class_Combined.value_Const (Object'Access) /= 14 then
...
end Interface_Secondary_Base_Qualified_Consumer;
